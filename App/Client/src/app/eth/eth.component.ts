...
export class ETHComponent implements AfterViewInit, OnInit, OnDestroy {

  constructor(private dataService:DataService){

  }

  @ViewChild('ETHChart') myChart: jqxChartComponent;
  ...
  ngAfterViewInit(): void {
    ...
    this.dataService.sendMessage("join","ETHUSD");
  }

  ngOnDestroy(): void {

    this.dataService.sendMessage("leave", "ETHUSD");
